-- =============================================================================
-- CONEXÃO PALMEIRA - POLÍTICAS RLS E RESTANTE DA ESTRUTURA (PARTE 2)
-- =============================================================================

-- RLS Policies para course_modules que estavam faltando
...
-- RLS Policies para enrollments que estavam faltando
